    ...
    <footer id="footer-stamp" className="bg-gray-50 border-t border-gray-150 py-12 relative overflow-hidden text-center selection:bg-[#7EC8FF] selection:text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center space-x-2">
          <span className="w-8 h-8 rounded-lg bg-gray-950 flex items-center justify-center font-poppins font-bold text-white text-sm select-none">
            NS
          </span>
          <div className="text-left">
            <p className="font-poppins font-bold text-sm text-gray-950 leading-none">
              {PERSONAL_INFO.name}
            </p>
            <p className="font-sans text-[10px] text-gray-400 mt-1 uppercase tracking-wider">
              Designing experiences • Since 2024
            </p>
          </div>
        </div>
        ...
        <div className="text-xs font-mono text-gray-400">
          <span>© {new Date().getFullYear()} Naela Syifa. All Rights Reserved.</span>
        </div>
